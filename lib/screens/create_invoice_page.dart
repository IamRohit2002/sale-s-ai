        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () async {
              ...
              var companyName = controller.companyName;
              await uploadFileToFirebase(file, companyName, e.customerName);
            },
            label: const Text("Backup Invoice PDF"),
          ...
          TextButton.icon(
            ...
            style: TextButton.styleFrom(
              foregroundColor: controller.themeColor.value,
              shape: const StadiumBorder(),
              elevation: 0,
            ),
          ),
...
Future<void> uploadFileToFirebase(
    File file, RxString userId, String customerName) async {
  try {
    String formattedDate =
        DateFormat('dd-MM-yyyy_HH:mm').format(DateTime.now());
    String fileName = '$formattedDate-$customerName.pdf';
    final Reference storageReference = FirebaseStorage.instance
        .ref()
        .child('user_invoices/${userId.value}/$fileName');
          ...
          children: [
            ...
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  pw.SizedBox(height: 5),
                  pw.Text("Bill Date and Time", style: style1),
                  pw.SizedBox(height: 2),
